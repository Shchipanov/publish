...
var initTabs = function initTabs() {
  ...
  tabControls.forEach(function (control) {
    control.addEventListener('click', function (evt) {
      evt.preventDefault();
      var attribute = control.getAttribute('data-tab-control');
      var content = document.querySelector("[data-tab-content=\"".concat(attribute, "\"]"));
      ...
      for (var _i = 0; _i < tabContent.length; _i++) {
        if (tabContent[_i].classList.contains('subscriptions__sublist--active')) {
          tabContent[_i].classList.remove('subscriptions__sublist--active');
          break;
        }
      }
    ...
    control.addEventListener('keyup', function (event) {
      ...
      if (event.code === 'Enter') {
        ...
        for (var _i2 = 0; _i2 < tabContent.length; _i2++) {
          if (tabContent[_i2].classList.contains('subscriptions__sublist--active')) {
            tabContent[_i2].classList.remove('subscriptions__sublist--active');
            break;
          }
        }
        content.classList.add('subscriptions__sublist--active');
