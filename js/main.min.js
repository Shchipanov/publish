...
/* harmony import */ var _modules_get_mask__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/get-mask */ "./js/modules/get-mask.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_slider__WEBPACK_IMPORTED_MODULE_2__["sliderTrainers"])();
    Object(_modules_slider__WEBPACK_IMPORTED_MODULE_2__["sliderReviews"])();
    Object(_modules_slider__WEBPACK_IMPORTED_MODULE_2__["removeNotJs"])();
    Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["selectTab"])();
    Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["removeNotJsTab"])(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["tabsContent"]);
    Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["removeNotJsTab"])(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["tabsControl"]);
    Object(_modules_get_mask__WEBPACK_IMPORTED_MODULE_4__["getMask"])();
  });
});
...
function getMask() {
  if (document.querySelector('[data-phone]')) {
    var inputs = document.querySelectorAll('[data-phone]');
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      for (var _i = 0, _arr = ['input', 'blur', 'focus']; _i < _arr.length; _i++) {
        var ev = _arr[_i];
        elem.addEventListener(ev, getMask);
      }
    }
  } catch (err) {
    _iterator.e(err);
...
/*!******************************!*\
  !*** ./js/modules/slider.js ***!
  \******************************/
/*! exports provided: sliderTrainers, sliderReviews, removeNotJs */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var sliderTrainers = function sliderTrainers() {
  if (!swiperContainer) {
    ...
    var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('[data-swiper="trainers"]', {
...
/*!****************************!*\
  !*** ./js/modules/tabs.js ***!
  \****************************/
/*! exports provided: selectTab, removeNotJsTab, tabsControl, tabsContent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "selectTab", function() { return selectTab; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "removeNotJsTab", function() { return removeNotJsTab; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "tabsControl", function() { return tabsControl; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "tabsContent", function() { return tabsContent; });
var tabsControl = document.querySelectorAll('[data-tab-control]');
var tabsContent = document.querySelectorAll('[data-tab-content]');
var selectTab = function selectTab() {
  if (tabsControl.length >= 1) {
    var _loop = function _loop(i) {
      var tubControl = tabsControl[i];
      var tabContent = tabsContent[i];
      tubControl.addEventListener('click', function (evt) {
        evt.preventDefault();
        tabsControl.forEach(function (tub) {
    ...
    for (var i = 0; i < tabsControl.length; i++) {
      _loop(i);
    }
  }
};
var removeNotJsTab = function removeNotJsTab(elements) {
